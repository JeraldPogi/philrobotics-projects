...
*
*---------------------------------------------------------------------------------------------
* |Filename:      | "sdcc_PIC16.h"                            	|
* |:----          |:----                                        |
* |Description:   | SDCC PIC16 Register Definitions   			|
* |Revision:      | v00.02.00                                   |
...
* |:----        |:----      |:----              |:----                              |
* |v00.01.00    |20130821   |ESCII       	|Library Initial Release            |
*********************************************************************************************/
#define __SHOW_MODULE_HEADER__ /*!< \brief This section includes the Module Header on the documentation */
#undef  __SHOW_MODULE_HEADER__

#ifndef __SDCC_PIC16_H
#define __SDCC_PIC16_H
