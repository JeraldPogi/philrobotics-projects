...
void setupADCPinsToDigital(void)
{
	...
	REGISTER_TRISA = K8_DEFAULT_CONFIG_PORTA	
	REGISTER_PORTA = K8_DEFAULT_CONFIG_PORTA;

	REGISTER_TRISE = K8_DEFAULT_CONFIG_PORTE;
	REGISTER_PORTE = K8_DEFAULT_CONFIG_PORTE;
}
