...
#define DIS_PORTB_PULLUP    RBPU
#define INT0_EDGE           INTEDG0
#define INT1_EDGE           INTEDG1
#define INT2_EDGE           INTEDG2

#define REGISTER_INTCON3    INTCON3
#define BIT_INTCON_INT1E    INT1IE
#define BIT_INTCON_INT1F    INT1IF
#define BIT_INTCON_INT2E    INT2IE
#define BIT_INTCON_INT2F    INT2IF
