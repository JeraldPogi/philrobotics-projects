...
baud EQU 57600			; standard TinyBld baud rates: 115200 or 19200
	...
	#include "../spbrgselect.inc"	; RoundResult and baud_rate
		...
		;__CONFIG	_CONFIG1H = _OSC_HSPLL_1H & _IESO_OFF_1H & _FCMEN_OFF_1H
		;__CONFIG	_CONFIG2L = _BOREN_OFF_2L & _BORV_20_2L & _PWRT_ON_2L
		;__CONFIG	_CONFIG2H = _WDT_OFF_2H & _WDTPS_1_2H
		;__CONFIG	_CONFIG3H = _MCLRE_ON_3H & _PBADEN_OFF_3H 

		CONFIG OSC=HSPLL            ; 8Mhz Crystal x 4 PLL
		CONFIG LVP=OFF
		CONFIG PWRT=ON
		CONFIG BOREN=OFF
		CONFIG MCLRE=ON
